...
int lbl_num_flag,lbl_num_flag_2,lbl_num_flag_3,lbl_num_flag_4,lbl_num_flag_5;
int lbl_num_temp,lbl_num_temp_2,lbl_num_temp_3,lbl_num_temp_4,lbl_num_temp_5;

struct _historyinfor history_buf[1001];
int sum=0;
...
void p03_historyquery_dialog::init_page_val()
{
    ...
    sum=HistoryAnanisis_show(history_path, history_buf,1001);
...
void p03_historyquery_dialog::on_pbtn_up_clicked()
{
    ...
    if(sum - lbl_num >= 5)   // 11 - 6
    {
        ...
        //11 - 11
        start=history_buf[sum - lbl_num].Start_Soc;
        start_2= history_buf[sum - lbl_num_2].Start_Soc;
        start_3= history_buf[sum - lbl_num_3].Start_Soc;
        start_4= history_buf[sum - lbl_num_4].Start_Soc;
        start_5= history_buf[sum - lbl_num_5].Start_Soc;

        end= history_buf[sum - lbl_num].Stop_Soc;
        end_2= history_buf[sum - lbl_num_2].Stop_Soc;
        end_3= history_buf[sum - lbl_num_3].Stop_Soc;
        end_4= history_buf[sum - lbl_num_4].Stop_Soc;
        end_5= history_buf[sum - lbl_num_5].Stop_Soc;

        meter= (float)history_buf[sum - lbl_num].Use_kwh/100;
        meter_2= (float)history_buf[sum - lbl_num_2].Use_kwh/100;
        meter_3= (float)history_buf[sum - lbl_num_3].Use_kwh/100;
        meter_4= (float)history_buf[sum - lbl_num_4].Use_kwh/100;
        meter_5= (float)history_buf[sum - lbl_num_5].Use_kwh/100;

        chtime= history_buf[sum - lbl_num].chargecontinuetm/60;
        chtime_2= history_buf[sum - lbl_num_2].chargecontinuetm/60;
        chtime_3= history_buf[sum - lbl_num_3].chargecontinuetm/60;
        chtime_4= history_buf[sum - lbl_num_4].chargecontinuetm/60;
        chtime_5= history_buf[sum - lbl_num_5].chargecontinuetm/60;


        memcpy(lbl_txt, history_buf[sum - lbl_num].CardNumber,sizeof(history_buf[sum - lbl_num].CardNumber));
        memcpy(lbl_txt_2, history_buf[sum - lbl_num_2].CardNumber,sizeof(history_buf[sum - lbl_num_2].CardNumber));
        memcpy(lbl_txt_3, history_buf[sum - lbl_num_3].CardNumber,sizeof(history_buf[sum - lbl_num_3].CardNumber));
        memcpy(lbl_txt_4, history_buf[sum - lbl_num_4].CardNumber,sizeof(history_buf[sum - lbl_num_4].CardNumber));
        memcpy(lbl_txt_5, history_buf[sum - lbl_num_5].CardNumber,sizeof(history_buf[sum - lbl_num_5].CardNumber));
    }
    else
    {
...
void p03_historyquery_dialog::on_pbtn_down_clicked()
{
    ...
    if(lbl_num > 5)
    {
        ...
        if(lbl_num_flag_2 == 1)
        {
            lbl_num_2 = lbl_num_temp_2;
            lbl_num_temp_2 = 0;
            lbl_num_flag_2 = 0;
        }
        if(lbl_num_flag_3 == 1)
        {
            lbl_num_3 = lbl_num_temp_3;
            lbl_num_temp_3 = 0;
            lbl_num_flag_3 = 0;
        }
        if(lbl_num_flag_4 == 1)
        {
            lbl_num_4 = lbl_num_temp_4;
            lbl_num_temp_4 = 0;
            lbl_num_flag_4 = 0;
        }
        if(lbl_num_flag_5 == 1)
        {
            lbl_num_5 = lbl_num_temp_5;
            lbl_num_temp_5 = 0;
            lbl_num_flag_5 = 0;
        }
