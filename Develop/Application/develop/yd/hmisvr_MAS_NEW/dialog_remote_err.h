#ifndef DIALOG_REMOTE_ERR_H
#define DIALOG_REMOTE_ERR_H

#include <QDialog>

namespace Ui {
class dialog_remote_err;
}

class dialog_remote_err : public QDialog
{
    Q_OBJECT

public:
    explicit dialog_remote_err(QWidget *parent = 0);
    ~dialog_remote_err();
